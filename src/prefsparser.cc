...
void PrefsParser::parse(FILE *fp)
{
   ...
   SymNode_t symbols[] = {
      ...
      { "font_cursive", &prefs.preferences.font_cursive, PREFS_STRING, 0 },
      { "font_factor", &prefs.preferences.font_factor, PREFS_DOUBLE, 0 },
      { "font_fantasy", &prefs.preferences.font_fantasy, PREFS_STRING, 0 },
      { "font_max_size", &prefs.preferences.font_max_size, PREFS_INT32, 0 },
      { "font_min_size", &prefs.preferences.font_min_size, PREFS_INT32, 0 },
      { "font_monospace", &prefs.preferences.font_monospace, PREFS_STRING, 0 },
      { "font_sans_serif", &prefs.preferences.font_sans_serif, PREFS_STRING, 0 },
      { "font_serif", &prefs.preferences.font_serif, PREFS_STRING, 0 },
