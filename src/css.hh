...
void css_style_sheet_apply_style_sheet(c_css_style_sheet_t * style_sheet, c_css_declaration_set_t * decl_set,
                                       int doc_tree_ref,
                                       const c_doctree_node_t * dtn,
                                       c_css_match_cache_t * match_cache);
